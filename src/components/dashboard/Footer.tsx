...
export default function Footer() {
  return (
    <footer className="bg-surface text-foreground py-12 px-4">
      <div className="container mx-auto max-w-7xl">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image src="/logo.svg" alt="SnapIter Logo" width={30} height={30} />
              <span className="text-xl font-bold">SnapIter</span>
            </div>
            <p className="text-muted text-sm">Snap, Track, Trust.
            </p>
          </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted text-sm">
              © 2024 SnapIter. All rights reserved. Open Source under MIT License.
            </p>
